  ...
  return (
    <>
      <div className="flex justify-center space-x-4 mb-6">
        <Link href="/login" className="px-6 py-2 bg-primary text-white font-medium rounded-md">
          Login
        </Link>
        <Link href="/register" className="px-6 py-2 bg-white/30 backdrop-blur-sm text-gray-700 dark:text-white font-medium rounded-md hover:bg-white/40 dark:hover:bg-white/10 transition-colors">
          Registro
        </Link>
      </div>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                required
                className="focus:ring-primary focus:border-primary block w-full pl-10 pr-10 py-3 border border-gray-300 dark:border-gray-600 rounded-md placeholder-gray-400 text-gray-900 dark:text-white bg-white/50 dark:bg-gray-800/50 backdrop-blur-sm"
                placeholder="••••••••"
                value={password}
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center">
            <input
              ...
              name="remember-me"
              type="checkbox"
              className="h-4 w-4 text-primary focus:ring-primary border-gray-300 dark:border-gray-600 rounded bg-white/50 dark:bg-gray-800/50"
            />
